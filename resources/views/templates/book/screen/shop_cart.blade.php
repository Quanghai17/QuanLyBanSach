...
{{--                </tr>--}}
                ...
                <tr>
                    <td class="form-group {{ $errors->has('province') ? ' has-error' : '' }}">
                        <label for="province" class="control-label"><i class="fa fa-list-ul"></i>Tỉnh/Thành
                            phố:</label>
...
{{-- End total --}}
        ...
        <div class="row" style="padding-bottom: 20px;">
            <div class="col-md-12 text-center">
                    <div class="pull-right">
                        <button style="background: #62ab00;
                        color: #fff !important;" class="btn btn-success" id="submit-order" type="button" style="cursor: pointer;padding:10px 30px"><i class="fa fa-check"></i> {{ trans('cart.checkout') }}</button>
                    </div>
            </div>
        </div>
