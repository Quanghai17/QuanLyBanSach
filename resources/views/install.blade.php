...
<div class="container">
    ...
    <div class="col-md-5 col-sm-8">
        ...
        <button type="button" class="btn btn-default dropdown-toggle usa" data-toggle="dropdown">
            ...
            <img src="https://noithatnhatrang.com.vn/data/language/flag_vn.png" style="height: 25px;">
            @else
            <img src="https://noithatnhatrang.com.vn/data/language/flag_uk.png" style="height: 25px;">
            @endif
        ...
        <span class="caret"></span>
          ...
          <ul class="dropdown-menu" >
              <li><a href="install.php"><img src="https://noithatnhatrang.com.vn/data/language/flag_uk.png" style="height: 25px;"></a></li>
              <li><a href="install.php?lang=vi"><img src="https://noithatnhatrang.com.vn/data/language/flag_vn.png" style="height: 25px;"></a></li>
          </ul>
        </div>
