...
//topMenuRight
$data['topMenuRight'][] ='<a href="https://noithatnhatrang.com.vn/docs/master/api-shop-info.html" target="_new"><i class="fa fa-info-circle" aria-hidden="true"></i> '.trans('admin.more_info').'</a>';
//=topMenuRight
