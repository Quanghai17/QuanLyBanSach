                    ...
                    <div class="fields-group">
                        ...
                        <div
                            ...
                            <label for="{{ $code }}__title"
                                class="col-sm-2  control-label">{{ trans('Plugins/Cms/Content::Category.title') }} <span class="seo" title="SEO"><i class="fa fa-coffee" aria-hidden="true"></i></span></label>
                            <div class="col-sm-8">
                        ...
                        <div
                            ...
                            <label for="{{ $code }}__keyword"
                                class="col-sm-2  control-label">{{ trans('Plugins/Cms/Content::Category.keyword') }} <span class="seo" title="SEO"><i class="fa fa-coffee" aria-hidden="true"></i></span></label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                        ...
                        <div
                            ...
                            <label for="{{ $code }}__description"
                                class="col-sm-2  control-label">{{ trans('Plugins/Cms/Content::Category.description') }} <span class="seo" title="SEO"><i class="fa fa-coffee" aria-hidden="true"></i></span></label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group  {{ $errors->has('parent') ? ' has-error' : '' }}">
                            <label for="parent"
                                class="col-sm-2 asterisk control-label">{{ trans('Plugins/Cms/Content::Category.admin.select_category') }}</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group   {{ $errors->has('image') ? ' has-error' : '' }}">
                            <label for="image"
                                class="col-sm-2  control-label">{{ trans('Plugins/Cms/Content::Category.image') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                        ...
                        <div class="form-group   {{ $errors->has('alias') ? ' has-error' : '' }}">
                            <label for="alias"
                                class="col-sm-2  control-label">{!! trans('Plugins/Cms/Content::Category.alias') !!}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                        ...
                        <div class="form-group   {{ $errors->has('sort') ? ' has-error' : '' }}">
                            <label for="sort"
                                class="col-sm-2  control-label">{{ trans('Plugins/Cms/Content::Category.sort') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                        ...
                        <div class="form-group  ">
                            <label for="status"
                                class="col-sm-2  control-label">{{ trans('Plugins/Cms/Content::Category.status') }}</label>
                            <div class="col-sm-8">
                                <input type="checkbox" name="status" class="input"
